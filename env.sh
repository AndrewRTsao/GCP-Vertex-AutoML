...
export DATASET_NAME="azure_vm_testing" # What you want to name your dataset in BigQuery and your feature store in Vertex (should be lowercase)
...
export BUCKET_NAME="vertex-dbt-bucket" # Staging bucket where all data associated with model resources and pipeline will be stored (will be created under your project)
...
# Cleanup
export DELETE_BUCKET="False" # Set to True / False whether you want to delete contents of staging bucket (i.e. delete all Vertex and model artifacts)
