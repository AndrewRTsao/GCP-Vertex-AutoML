...
if __name__ == "__main__":
    ...
    print("Creating vm_errors entity type")
    ...
    print("Ingesting feature data into entity type")
    ...
    print("Creating vm_failures entity type")
    ...
    print("Creating vm_hourly_status entity type")
    ...
    print("Creating vm_machines entity type")
    ...
    print("Creating vm_maintenance entity type")
    ...
    print("Creating vm_telemetry entity type")
    ...
    pass_through_fields = ["machine_id", "failure_in_" + os.getenv('PREDICTION_PERIOD'), "split"]
    ...
    print("Serving features and creating final training dataset")
